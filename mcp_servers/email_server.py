...
# --- folder + message-parsing helpers moved to mcp_servers/email_server_helpers.py
# (ADR-052); re-imported so the tool handlers below keep calling them.
from mcp_servers.email_server_helpers import (  # noqa: E402,F401
    _detect_sent_folder,
