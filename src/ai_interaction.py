...
# --- chat/teacher/opinion handlers moved to src/ai_chat.py (ADR-056); re-imported
# so the dispatcher (stream_ai_tool) keeps working.
from src.ai_chat import (  # noqa: E402,F401
    do_chat_with_model,
    do_ask_teacher,
    do_second_opinion,
)
...
# --- session-mgmt handlers moved to src/ai_sessions.py (ADR-055); re-imported so
# the dispatcher (stream_ai_tool) keeps working.
from src.ai_sessions import (  # noqa: E402,F401
    do_create_session,
    do_list_sessions,
    do_send_to_session,
)
