...
# Ollama helpers extracted to src/adapters/ollama.py (ADR-068); re-imported
# so callers keep using src.llm_core.* unchanged.
from src.adapters.ollama import (  # noqa: E402,F401
