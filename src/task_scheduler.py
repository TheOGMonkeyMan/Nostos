...
# --- pure module-level scheduler helpers moved to src/scheduler_helpers.py
# (ADR-045); re-imported so the public API (compute_next_run) + the bare-name
# references in the TaskScheduler class below keep working. HOUSEKEEPING_DEFAULTS
# + RETIRED_HOUSEKEEPING_ACTIONS stay defined below (security test pins them here).
from src.scheduler_helpers import (  # noqa: E402,F401
    _cached,
    compute_next_run,
...
from src.scheduler_notifications import _NotificationMixin  # noqa: E402
from src.scheduler_execution import _ExecutionMixin  # noqa: E402


class TaskScheduler(_ExecutionMixin, _NotificationMixin):
