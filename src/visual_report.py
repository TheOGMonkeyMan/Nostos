...
# --- the per-category CSS builder moved to src/visual_report_css.py (ADR-051);
# re-imported so generate_visual_report keeps calling it.
from src.visual_report_css import _category_css  # noqa: E402,F401
